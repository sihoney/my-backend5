...
/*
도메인 수정은 최소화 (팀원들과 공유하기 때문)
 */

@Entity
@Getter
@Table(name = "\"product\"", schema = "public")
@Schema(description = "제품에 해당하는 도메인")
// @Schema: 데이터 모델(클래스나 필드)을 설명, 요청이나 응답에서 쓰이는 데이터 구조가 어떤 의미인지
public class Product {

    @Id
    @Schema(description = "", example = "", accessMode = Schema.AccessMode.READ_ONLY)
    private UUID id;
